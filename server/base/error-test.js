...
describe('defining error', function () {
...
describe('error(normal error)', function () {
  it('should succeed', function () {
...
describe('error(form error)', function () {
  it('should succeed', function () {
...
describe('error find', function () {
  ...
  it('should succeed for form errors', function () {
    var err = error('NAME_DUPE');
...
describe('assert2.error', function () {
  it('should succeed', function () {
    var err = error('INVALID_DATA');
    assert2.error(err, 'INVALID_DATA');
  });
  it('should fail', function () {
    var err = error('INVALID_DATA');
    assert.throws(function () {
      assert2.error(err, 'NAME_DUPE');
    });
  });
  it('should succeed for form errors', function () {
    var err = error([ error.NAME_DUPE, error.PASSWORD_EMPTY]);
    assert2.error(err, 'NAME_DUPE');
  });
  it('should fail for form errors', function () {
    var err = error([ error.NAME_DUPE ]);
    assert.throws(function () {
      assert2.error(err, 'PASSWORD_EMPTY');
    });
  });
});
